# =============================================================================
# 비즈니스 관리 시스템 공지사항 앱 뷰
# =============================================================================
# 설명: 공지사항 관리를 위한 모든 뷰 함수를 정의
# 작성자: 비즈니스 관리 시스템 개발팀
# 버전: 1.0.0
# =============================================================================
...
def index(request):
    ...
    Description:
        - 공지사항 목록을 페이지네이션하여 표시
        - 검색 기능: 제목과 내용에서 검색어 찾기
        - 필터링 기능: 중요도, 상태별 필터링
        - 권한 관리: 일반 사용자는 게시된 공지만 볼 수 있음
        - 성능 최적화: 필요한 데이터만 쿼리
    """
    # =============================================================================
    # 요청 파라미터 처리
